...
public class UnityHelper
{
    ...
    // public static AudioSource PlaySound(FunctionWeight weight, string defaultPath, bool loop = false)
    // {
    //     // string path = SysDefines.AUDIO + "孙悟空 连击重音";
    //     // string newPath = GetRootPath1(weight, SysDefines.AUDIO + defaultPath);
    //     // AudioSource mAudioClip = AudioManager.Instance.PlaySoundEff2D(newPath, loop);
    //     // return mAudioClip;
    // }
}