...
{
    /// <summary>
    /// QL API: client.account.forgot.password
    /// </summary>
    public class ClientAccountForgotPasswordRequest : BaseQLRequest<QL.Protocol.ClientAccountForgotPasswordResponse>
    {
        /// <summary>
        /// 区服Id
        /// </summary>
        ...
        {
            return "client.account.forgot.password";
        }
