...
namespace JBPROTO
{
    ...
    class NetByteArray
    {
        ...
        public bool isEmpty() => EntityLength == 0;

        public void clear() => EntityLength = 0;
    ...
    class NetData
    {
        ...
        public void acceptProtocolData(byte[] buffer, int length)
        {
            ...
            NetByteArray nba = cacheProtocolDataList[cacheProtocalValidLength++];
        ...
        public void dispatchProtocols(INetReactor reactor, List<INetResponser> responsers)
        {
            while (cacheProtocalValidLength > 0)
            {
                ...
                if (!nba.isEmpty())
                {
                    var sharedStream = new MemoryStream(nba.Data, 4, nba.EntityLength - 4);
