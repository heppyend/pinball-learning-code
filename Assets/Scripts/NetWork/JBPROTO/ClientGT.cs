...
namespace JBPROTO
{
    ...
    /// </summary>
    public sealed class CLGTKeepAliveReq : INetProtocol
    {
        /// <summary>
        /// 协议模块ID
        /// </summary>
    ...
    /// 心跳包回应
    /// </summary>
    public sealed class CLGTKeepAliveAck : INetProtocol
    {
        /// <summary>
        /// 协议模块ID
        /// </summary>
    ...
    public class ClientGTResponserBase : INetResponser
    {
        public bool processPackage(BinaryReader br, INetReactor reactor, out INetProtocol responseProto)
        {
            ...
            switch(br.ReadUInt16())
            {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    responseProto = new CLGTKeepAliveReq();
                    responseProto.fromBinary(br);
                    reactor?.onRecvMessage(responseProto);
                    onRecv_CLGTKeepAliveReq(responseProto as CLGTKeepAliveReq);
                    break;
                case 9:
                    responseProto = new CLGTKeepAliveAck();
                    responseProto.fromBinary(br);
                    reactor?.onRecvMessage(responseProto);
                    onRecv_CLGTKeepAliveAck(responseProto as CLGTKeepAliveAck);
                    break;
            }
        ...
        public virtual void onRecv_CLGTKeepAliveReq(CLGTKeepAliveReq proto) { }
        public virtual void onRecv_CLGTKeepAliveAck(CLGTKeepAliveAck proto) { }
    }
}
