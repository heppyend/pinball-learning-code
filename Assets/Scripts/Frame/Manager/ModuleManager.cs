...
public class ModuleManager : Singleton<ModuleManager>
{
    ...
    {
        Type t = typeof(T);
        //UnityEngine.Debug.LogError(">>Get>>" + t.ToString() +","+ dicModules.ContainsKey(t.ToString()));
    ...
    public void RegisterAllModules()
    {
        ...
        LoadModule(typeof(LobbyModule));
        LoadModule(typeof(MarbleRoomModule));
    }
    ...
    {
        UnityEngine.Debug.LogError("UnRegister------");
